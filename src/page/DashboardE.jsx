...
import { Package, Play, CheckCircle} from "react-feather";
...
const Dashboard = () => {
    ...
    const tasks = [
        { title: "new Task", route: "/newtask", icon: <Play className="text-blue-500 text-5xl" /> },
        { title: "done Tasks", route: "/donetask", icon: <CheckCircle className="text-green-500 text-5xl" /> },
    ];
